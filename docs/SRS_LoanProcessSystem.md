...
*Nội dung trùng với `SRS_LoanProcessSystem_Final.docx` trong thư mục này. Để giữ đúng template Word (font, màu, viền), hãy mở file `.docx` bằng Word hoặc tải lên Google Drive rồi **Open with → Google Docs**.*
